...
twotheta = neutron.bragg_wavenumber2angle(wavenumber=ki, lattice_distance=instr.interplanar_pg002)
kf = neutron.energy2wavenumber(energy=neutron.wavenumber2energy(ki) - hw_max)
